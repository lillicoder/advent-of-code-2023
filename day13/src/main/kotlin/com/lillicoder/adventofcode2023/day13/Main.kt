...
fun main() {
    val grids = GridParser().parseList("input.txt") { it }
    val calculator = ReflectionCalculator()
    val sum = calculator.sumReflections(grids)
    println("Sum of reflections of the grids is $sum.")

    val smudged = calculator.sumReflections(grids, true)
    println("Sum of reflections w/ smudges is $smudged.")
}
...
class ReflectionCalculator {
     ...
     */
    fun sumReflections(grids: List<Grid<String>>, allowSmudge: Boolean = false) = grids.sumOf {
        countReflectedColumnsAndRows(it, allowSmudge)
    }
     ...
     */
    private fun countMismatches(first: List<Node<String>>, second: List<Node<String>>): Int =
     ...
     */
    private fun countReflectedColumnsAndRows(grid: Grid<String>, allowSmudge: Boolean = false): Long {
     ...
     */
    private fun findHorizontalSymmetry(grid: Grid<String>, allowSmudge: Boolean = false): Long {
     ...
     */
    private fun findVerticalSymmetry(grid: Grid<String>, allowSmudge: Boolean = false): Long {
     ...
     */
    private fun hasHorizontalSymmetry(grid: Grid<String>, index: Int, allowSmudge: Boolean = false): Boolean {
        var start = index
        var end = index + 1
     ...
     * @return True if grid is symmetrical, false otherwise.
     */
    private fun hasVerticalSymmetry(grid: Grid<String>, index: Int, allowSmudge: Boolean = false): Boolean {
